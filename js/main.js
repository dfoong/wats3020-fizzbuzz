...
while(!isInteger) {
//Debbie's notes: Integer = any number not a decimal or fraction
//changed max number to 30 for easier understanding of *3 *5 multiples.
  
maxNumber = prompt('Enter a number over zero (must be an integer aka non-decimal.):', 30);
...
//Debbie's notes: fbResults are also left empty for user generated results.
...
//Debbie's notes: fbText is left empty for the generated phrases, e.g. Fizz or Buzz.
